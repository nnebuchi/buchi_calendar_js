...
export const showCalendar = async (thisMonth=0, userConfig) => {
    ...
    document.querySelector('.bjs-calendar-next').addEventListener('click', showNextMonth);
    document.querySelector('.bjs-calendar-prev').addEventListener('click', showPreviousMonth);
...
document.querySelector('.buchi-time-add-div').addEventListener('click', setSchedule);
